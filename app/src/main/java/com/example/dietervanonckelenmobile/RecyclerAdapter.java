...
public  class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder>{
    ...
    private List<UurObject> uren;
    private OnItemClickListener mListener;

    public RecyclerAdapter(Context context, List<UurObject> uploads) {
        mContext = context;
        uren = uploads;
    }
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        UurObject huidigObject = uren.get(position);
        holder.nameTextView.setText(huidigObject.getNaam());
        holder.descriptionTextView.setText(huidigObject.getLes());
